...
const Home = () => {
  ...
  return (
    <div className='flex justify-center flex-col items-center p-10'>
      ...
      <div className='bg-blue-500 w-[50vw] h-[10vh] flex justify-between items-center p-4'>
        <h1 className='text-white'>Total Friends: {friends.length}<br/>Total Points: {friends.reduce((acc, friend) => acc + friend.Points, 0)}</h1>
        <button className='text-black w-[10vw] h-[5vh] flex flex-row items-center justify-between p-2'>Leaderboard <img src={user} alt="user" className='w-[1vw] h-[2vh] mr-1'/></button>
      </div>
      ...
      <ul className='w-[50vw]'>
        {friends.map((friend, index) => (
          <li
            ...
            className='flex justify-between p-3 mt-3 h-[10vh] items-center hover:bg-slate-200 rounded'
          >
